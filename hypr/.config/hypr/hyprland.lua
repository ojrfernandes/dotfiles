...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgb(cdd6f4)", "rgb(cdd6f4)"}, angle = 45 },
...
-- Volume control
hl.bind("ALT + UP", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"))
...
hl.bind(mainMod .. " + SHIFT + down", hl.dsp.window.resize({ x = 10, y = -10, relative = true}), { repeating = true })
